...
const SearchBar = () => {
  return (
    <div className="mb-4 flex @2xl:mb-0">
      <input
        className="rounded-l-2xl border border-youtube-light-border-color bg-transparent py-2 pl-3 pr-2 capitalize text-black placeholder:lowercase focus:outline-1 dark:border-youtube-dark-border-color dark:text-white dark:focus:outline-none"
        placeholder="Search..."
      ></input>
